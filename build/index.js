...
function useDroppableMeasuring(containers, {
  ...
  const measureDroppableContainers = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((ids = []) => {
...
function useRect(element, measure = getClientRect, fallbackRect) {
...
const DndContext = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.memo)(function DndContext({
  ...
  const scrollableAncestors = useScrollableAncestors(isInitialized ? overNode != null ? overNode : draggingNode : null);
...
function NullifiedContextProvider({
  children
}) {
...
const PositionedOverlay = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(({
  as,
  activatorEvent,
  adjustScale,
  children,
...
const defaultDropAnimationSideEffects = options => ({
  ...
  if (styles == null ? void 0 : styles.active) {
  ...
  if (styles == null ? void 0 : styles.dragOverlay) {
  ...
  if (className == null ? void 0 : className.active) {
    active.node.classList.add(className.active);
  }

  if (className == null ? void 0 : className.dragOverlay) {
...
function Edit(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)({
    ...
    template: [['mikeforscutt/team-member', {}], ['mikeforscutt/team-member', {}], ['mikeforscutt/team-member', {}]] // templateLock="insert"
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)('mikeforscutt/team-members', {
    ...
    from: [{
      ...
      transform: _ref => {
        ...
        const innerBlocks = images.map(_ref2 => {
          ...
          return (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.createBlock)('mikeforscutt/team-member', {
            alt,
            id,
            url
          });
        });
        return (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.createBlock)('mikeforscutt/team-members', {
          columns: columns || 2
        }, innerBlocks);
      }
    }, {
...
function Edit(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.PanelBody, {
    ...
    className: `wp-block-mikeforscutt-team-member-img${(0,_wordpress_blob__WEBPACK_IMPORTED_MODULE_5__.isBlobURL)(url) ? ' is-loading' : ''}`
    ...
    className: "wp-block-mikeforscutt-team-member-social-links"
    ...
    className: "wp-block-mikeforscutt-team-member-add-icon-li"
    ...
    className: "wp-block-mikeforscutt-team-member-link-form"
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)('mikeforscutt/team-member', {
  ...
  icon: 'admin-users',
  parent: ['mikeforscutt/team-members'],
  supports: {
    reusable: false,
    html: false
  },
  attributes: {
    ...
    socialLinks: {
      ...
      source: 'query',
      selector: '.wp-block-mikeforscutt-team-member-social-links ul li',
      query: {
        icon: {
          source: 'attribute',
          attribute: 'data-icon'
